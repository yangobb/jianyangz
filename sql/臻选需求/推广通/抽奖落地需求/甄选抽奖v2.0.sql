...
from (
    ...
    and inventorydate between date_add(current_date,1) and date_add(current_date,14) --未来14天
    and substr(a.gettime,9,2) = 14
) a
group by 1 
),
...
select *
    ,case when cast(`途占比` as decimal(9,2)) < 0.35 and cast(`满房率` as decimal(9,2)) between 0.4 and 0.8 and rn <= 600 then 100
        when cast(`途占比` as decimal(9,2)) < 0.35 and cast(`满房率` as decimal(9,2)) between 0.4 and 0.8 and cast(`途占比` as decimal(9,2)) = 0 and `LPV排序` = 0 then 30 
        when cast(`途占比` as decimal(9,2)) < 0.35 and cast(`满房率` as decimal(9,2)) between 0.4 and 0.8 then 50
        when cast(`途占比` as decimal(9,2)) < 0.35 and cast(`满房率` as decimal(9,2)) < 0.4 then 10 
        when cast(`途占比` as decimal(9,2)) < 0.35 and cast(`满房率` as decimal(9,2)) > 0.8 then 20 
        
        when cast(`途占比` as decimal(9,2)) > 0.35 and cast(`满房率` as decimal(9,2)) > 0.4 then 10
        when cast(`途占比` as decimal(9,2)) > 0.35 and cast(`满房率` as decimal(9,2)) < 0.4 then 20
        when cast(`途占比` as decimal(9,2)) > 0.35 then 10
